...
INSERT INTO "new_Shop" ("aggression", "aiGoal", "brandAccentColor", "brandFont", "brandLogoUrl", "brandPrimaryColor", "brandSecondaryColor", "budgetAmount", "budgetEnabled", "budgetPeriod", "budgetStartDate", "contributeToMetaLearning", "copyVariants", "createdAt", "customCSS", "id", "lastEvolutionCycle", "lastVariantUpdate", "mode", "plan", "shopifyDomain", "updatedAt") SELECT "aggression", "aiGoal", "brandAccentColor", "brandFont", "brandLogoUrl", "brandPrimaryColor", "brandSecondaryColor", "budgetAmount", "budgetEnabled", "budgetPeriod", "budgetStartDate", "contributeToMetaLearning", "copyVariants", "createdAt", "customCSS", "id", "lastEvolutionCycle", "lastVariantUpdate", "mode", "plan", "shopifyDomain", "updatedAt" FROM "Shop";
DROP TABLE "Shop";
