...
CREATE TABLE "new_Shop" (
    ...
    "avgRating" REAL,
    "reviewCount" INTEGER,
    "socialProofEnabled" BOOLEAN NOT NULL DEFAULT true,
    "socialProofType" TEXT NOT NULL DEFAULT 'orders',
    "socialProofMinimum" INTEGER NOT NULL DEFAULT 100,
    "socialProofUpdatedAt" TIMESTAMP,
