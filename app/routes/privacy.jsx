export default function Privacy() {
  return (
    <div style={{
      ...
      <p style={{ color: '#666', marginBottom: '30px' }}>Last updated: September 2026</p>
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <ul>
          ...
          <li>
            ...
            (local storage). It is generated by us, is not derived from any personal
            information, and is not linked to a Shopify customer account. We use it to avoid
            showing the same person the same offer repeatedly and to keep measurement groups
            stable across visits. A visitor can remove it by clearing their browser storage,
            and if storage is unavailable we simply proceed without one.
          </li>
        </ul>
      ...
      <section style={{ marginBottom: '30px' }}>
        ...
        <p>
          ...
          claiming it does, we hold back a randomly selected share of store visitors and show
          them nothing at all. We then compare how often each group completes a purchase. This
          is the only way to tell a real effect apart from sales that would have happened anyway.
        </p>
        <ul>
          <li>
        ...
        <p>
          We may change the size of the held-back group over time as a store's traffic grows. The
          purpose and the categories of data involved do not change when we do.
        </p>
      </section>
