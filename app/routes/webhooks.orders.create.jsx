...
export const action = async ({ request }) => {
  try {
    ...
    // This fires for every offer type (discount, no-discount, gift card) and
    ...
    console.log(` Exit intent offer attribution: ${exitDiscountUsed?.code || (exitIntentAttribute ? 'cart-attribute' : 'gift-card')}`);
    ...
    await recordUsageBilling(shop, payload, admin);
 ...
 */
async function recordUsageBilling(shop, orderPayload, admin) {
  try {
