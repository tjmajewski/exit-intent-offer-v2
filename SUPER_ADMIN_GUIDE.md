...
- **KPI tiles** with ▲▼ vs the prior period of the same length. Holdout lift = shown-group CVR minus holdout CVR (holdout is 10% of visitors) — same numbers as each merchant's dashboard lift card.
